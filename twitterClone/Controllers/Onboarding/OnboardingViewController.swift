...
class OnboardingViewController: UIViewController {
    ...
    private let createAccountButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(didTabCreateAcc), for: .touchUpInside)
        return button
    }()
    private let logInButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(didTabLogin), for: .touchUpInside)
